...
const ResultsPanel = ({ currentRevenue, revenueWithMonetizeMore, uplift, formatCurrency }) => (
    <div className="m2-w-full md:m2-w-1/2 md:m2-pl-8">
        <div className="m2-bg-white m2-rounded m2-p-4 md:m2-p-6 border border-[#D5D5DC]">
            <h2 className="m2-text-xl md:m2-text-2xl m2-font-semibold m2-text-gray-900 m2-mb-6">Your result</h2>
            
            <div className="m2-rounded m2-p-5 m2-mb-6 m2-relative" style={{background: "#191919"}}>
                <div className="m2-flex m2-flex-row m2-items-center m2-justify-between m2-gap-4">
                    <div className="m2-flex m2-items-start">
                        <div className="m2-mr-2 sm:m2-mr-4">
                            <svg width="28" height="98" viewBox="0 0 28 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 85L14 6" stroke="white" strokeWidth="3"/>
                                <path d="M2 16L14 3L26 16" stroke="white" strokeWidth="3"/>
                            </svg>
                        </div>
                        <div>
                            <span className="m2-text-white m2-text-5xl m2-font-semibold">33%</span>
                            <p className="m2-text-gray-300 m2-text-xs m2-mt-3">
                                Annual Revenue Uplift with MonetizeMore
                            </p>
                        </div>
                    </div>
                    
                    <div className="m2-flex m2-items-end m2-h-24 m2-w-24 m2-flex-shrink-0">
            ...
            <div className="m2-space-y-3 m2-mb-6">
                <div className="m2-flex m2-flex-row m2-justify-between m2-items-center">
                    <span className="m2-text-gray-700 m2-text-sm m2-font-normal">Annual Revenue</span>
                    <span className="m2-text-lg m2-font-semibold m2-text-gray-900">{formatCurrency(currentRevenue)}</span>
                </div>
                <div className="m2-flex m2-flex-row m2-justify-between m2-items-center">
                    <span className="m2-text-gray-700 m2-text-sm m2-font-normal">Annual Revenue with MonetizeMore</span>
            ...
            <div className="m2-border-t m2-border-gray-200 m2-pt-6 m2-mb-6">
                <div className="m2-flex m2-flex-row m2-justify-between m2-items-center">
                    <span className="m2-text-gray-900 m2-text-lg m2-font-medium">Uplift with MonetizeMore</span>
                    <span className="m2-text-3xl m2-font-semibold m2-text-gray-900">{formatCurrency(uplift)}</span>
                </div>
            </div>

            <button className="m2-w-full m2-text-white m2-text-lg m2-font-medium m2-py-3 m2-px-6 m2-rounded m2-transition-colors m2-duration-200 m2-mb-4 hover:m2-brightness-90" style={{background: "#AA3492"}}>
                Maximize revenue with MonetizeMore
            </button>

            <p className="m2-text-gray-500 m2-text-xs m2-leading-relaxed">
...
const App = () => {
  ...
  return (
    ...
    <div id="m2-revenue-calculator">
        <div className="m2-flex m2-flex-col md:m2-flex-row m2-min-h-screen m2-bg-gray-50 m2-p-4 md:m2-p-8 m2-font-sans">
            {/* Left Panel */}
            <div className="m2-w-full md:m2-w-1/2 md:m2-pr-8 m2-mb-8 md:m2-mb-0">
                <MetricsPanel 
